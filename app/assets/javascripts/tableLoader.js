...
var tableFourNoOrderPortraitBillsReceivedtwo = $('.dataTableFourNoOrderPortraitBillsReceivedtwo').DataTable({
  ...
  var dataTablestandardFact = $('.dataTablestandardFact').DataTable({
    "ordering": false,
    "language": {
      "sProcessing":     "Procesando...",
      "sLengthMenu":     "Mostrar _MENU_ registros",
    ...
    buttons: [
      {
        ...
        messageTop: "Facturación por empresa del " +  $("#initialDate").html() + "al " + $("#finalDate").html() + ". Fecha de impresión: " + $("#dateToday").html()
      },
      {
        extend: 'pdfHtml5',
        orientation: 'landscape',
    ...
    buttons: [
      {
        ...
        orientation: 'landscape',
        title: $("#storeName").html(),
        messageTop: "Movimientos agrupados del " +  $("#initialDate").html() + "al " + $("#finalDate").html() + ". Fecha de impresión: " + $("#dateToday").html()
      },
      {
        extend: 'pdfHtml5',
        orientation: 'landscape',
        title: $("#storeName").html(),
        messageTop: "Movimientos agrupados " +  $("#initialDate").html() + "al " + $("#finalDate").html() + ". Fecha de impresión: " + $("#dateToday").html(),
        customize: function(doc) {
          doc['footer'] = (function(page, pages) {
            return {
              columns: [
