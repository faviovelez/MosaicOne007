class BillingAddress < ActiveRecord::Base
  ...
  has_many :issuing_companies, class_name: 'BillingAddress', foreign_key: 'issuing_company_id'
  has_many :receiving_companies, class_name: 'BillingAddress', foreign_key: 'receiving_company_id'
